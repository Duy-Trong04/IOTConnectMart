...
@Composable
fun SearchScreen(navController: NavController, deviceViewModel: DeviceViewModel, username:String?){
 ...
 */
@Composable
fun CardDeviceSearch(device: Device, idCustomer:String?, username: String?, navController: NavController) {
    //format giá sản phẩm
